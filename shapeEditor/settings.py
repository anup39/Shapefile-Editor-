...
https://docs.djangoproject.com/en/3.1/topics/settings/python 
...
SECRET_KEY = '&3)qy8oti$x72okddo8dh-l$o&yk+f5+^uyve1(o3@s3y)w+jh'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,"upload_templates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
